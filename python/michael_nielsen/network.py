...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta, test_data=None):
        ...
        gradient descent. 
            ...
            The other non-optional parameters are 
                self-explanatory. 
            "test_data" -- If is provided 
                then the network will be evaluated 
        ...
        for j in xrange(epochs):
            ...
            for mini_batch in mini_batches:
                print "update_mini_batch_times: {}".format(i_update)
                i_update += 1
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            delta_nabla_b, delta_nabla_w = self.backprop(x, y) # main
    ...
    def backprop(self, x, y):
        ...
        # feedforward
        activation = x
        activations = [x] # list to all the activations, layer by layer
        ...
        # Note that the vairable l in the loop below is used a little 
